            ...
            <section className="flex w-full sticky top-0 inset-x-0 backdrop-blur-sm z-40">
                <nav ref={navRef} className="flex justify-between items-center h-14 md:h-20 w-full max-w-screen-8xl mx-auto p-5 px-5 sm:px-8 md:px-16">
                    ...
                    <div className="flex items-center justify-center gap-2 md:gap-3">
                        {children}
                        <a href={'https://github.com/ArjunAmbavane01/doodle'} target="_blank" rel="noreferrer" className="p-2 bg-white drop-shadow-lg shadow-sm shadow-blue-800 text-white rounded-full hover:bg-gray-100 transition-colors duration-300">
