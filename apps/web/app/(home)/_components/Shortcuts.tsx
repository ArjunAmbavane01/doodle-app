    ...
    <section className="w-full p-5 md:p-10 lg:p-20 py-24 bg-black relative overflow-hidden">
      ...
      <div className="flex flex-col gap-16 w-full max-w-screen-8xl mx-auto">
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl leading-tight">Work Faster with Shortcuts</h2>
          <p className="max-w-lg font-body text-md md:text-lg tracking-wide text-gray-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 px-8 md:px-10">
          {shortcuts.map((shortcut, index) => (
            ...
            >
              <div className="flex flex-col gap-5 h-full bg-white/5 rounded-lg p-8 backdrop-blur-xl border border-white/10 hover:border-white/30 transition-colors">
                ...
                <div className="flex flex-col text-center gap-1">
                  <p className="font-heading text-md md:text-lg">{shortcut.action}</p>
