...
const ToolButton = ({tool, activeTool, chooseTool}:ToolButtonProps) => {
    return ( <div
        ...
        className={`relative rounded-lg p-1.5 sm:p-2 md:p-2.5 hover:bg-black/10 font-heading group transition-colors duration-300 hover:scale-110 hover:cursor-pointer ${activeTool === tool.type ? "bg-blue-100 text-blue-800 hover:bg-blue-100" : "hover:bg-black/6"}`}
      >
