...
const CanvasRoom = ({ wsToken,roomMessages }: { wsToken: string, roomMessages:IChatMessage[] }) => {
    ...
    // const [roomShapes,setRoomShapes] = useState<Shape[]>(roomMessages);
    ...
    useEffect(() => {
        ...
        //             setRoomShapes(prevShapes => [...prevShapes, newShape]);
        //         }
        //     } catch (error) {
    ...
    return <Canvas socket={socket} roomMessages={roomMessages} />
}
